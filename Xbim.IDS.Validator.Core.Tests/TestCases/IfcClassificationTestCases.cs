...
namespace Xbim.IDS.Validator.Core.Tests.TestCases
{
    public class IfcClassificationTestCases : BaseTest
    {
        ...
        [InlineData("TestCases/classification/pass-non_rooted_resources_that_have_external_classification_references_should_also_pass.ids", false)]
        ...
        [InlineData("TestCases/classification/pass-systems_should_match_exactly_1_5.ids", false)]
        ...
        [InlineData("TestCases/classification/pass-systems_should_match_exactly_5_5.ids", false)]
        [InlineData("TestCases/classification/pass-values_match_subreferences_if_full_classifications_are_used__e_g__ef_25_10_should_match_ef_25_10_25__ef_25_10_30__etc_.ids", false)]
